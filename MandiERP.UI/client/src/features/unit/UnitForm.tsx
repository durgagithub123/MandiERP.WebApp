        ...
        <Container maxWidth="sm" >
            ...
            <form onSubmit={handleSubmit(onSubmit)} style={{ margin: 5, padding: 3 }} >
                <Grid container spacing={2}>
                    <Box mb={2}>
                        <AppTextInput control={control} label='Unit name' name='itemUnit' required={true} defaultValue='' ></AppTextInput>
                    </Box>
                    <Box mb={2}>
                        <AppTextInput control={control} label='Unit name (Hindi)' name='itemUnitHindi' required={false} defaultValue='' ></AppTextInput>
                    </Box>
                    <Box mb={2}>
