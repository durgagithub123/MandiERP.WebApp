create VIEW [dbo].[vw_RateDiffBillSale]
AS
SELECT     dbo.vw_panadetails.FarmerShortName, dbo.vw_panadetails.FarmerName, dbo.vw_panadetails.AccountFirmName, dbo.vw_panadetails.AccountName, 
                      ...
                      dbo.vw_BillDetail.Sevasulk, dbo.vw_BillDetail.Innam, dbo.vw_BillDetail.Stationery, dbo.vw_BillDetail.Postage, dbo.vw_BillDetail.Other, dbo.vw_panadetails.BillDate, 
                      dbo.vw_panadetails.SaleTypeFixOrWeightBased, dbo.vw_BillDetail.fkVillageID, dbo.vw_BillDetail.BillID, dbo.vw_BillDetail.AccountName AS Expr1
